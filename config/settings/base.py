...
DELIVERY_DEFAULT_FEE = env("DELIVERY_DEFAULT_FEE", default="0.00")
GOOGLE_MAPS_API_KEY = env("GOOGLE_MAPS_API_KEY", default="")
GOOGLE_MAPS_MAP_ID = env("GOOGLE_MAPS_MAP_ID", default="")
GOOGLE_MAPS_SERVER_API_KEY = env("GOOGLE_MAPS_SERVER_API_KEY", default="")
GOOGLE_ADDRESS_VALIDATION_ENABLED = env("GOOGLE_ADDRESS_VALIDATION_ENABLED", default=False, cast=bool)
GOOGLE_ADDRESS_VALIDATION_TIMEOUT_SECONDS = env("GOOGLE_ADDRESS_VALIDATION_TIMEOUT_SECONDS", default=4, cast=int)
GOOGLE_ROUTES_API_ENABLED = env("GOOGLE_ROUTES_API_ENABLED", default=False, cast=bool)
GOOGLE_ROUTES_API_KEY = env("GOOGLE_ROUTES_API_KEY", default="")
GOOGLE_ROUTES_TIMEOUT_SECONDS = env("GOOGLE_ROUTES_TIMEOUT_SECONDS", default=4, cast=int)
...
CELERY_TASK_ALWAYS_EAGER = env("CELERY_TASK_ALWAYS_EAGER", default=False, cast=bool)
CELERY_TASK_EAGER_PROPAGATES = env("CELERY_TASK_EAGER_PROPAGATES", default=True, cast=bool)
CELERY_TIMEZONE = TIME_ZONE
CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP = True
CELERY_TASK_TIME_LIMIT = env("CELERY_TASK_TIME_LIMIT", default=300, cast=int)
